...
for event in intree:
    ...
    emax_l00[0] = cal0Emax
    e2max_l00[0] = Find2ndMax(Energies0,Cellids0,2)
    ...
    emax_l01[0] = cal1Emax
    e2max_l01[0] = Find2ndMax(Energies1,Cellids1,2)
    w9st_l01[0] = Shower_width(Energies1, Cellids1, 3)
    w41st_l01[0] = Shower_width(Energies1, Cellids1, 21)
    eocore_l01[0] = eocorey(cal1Emax, Cellids1, Energies1, 3)
    edmax_l01[0] = edmaxy(cal1Emax, e2max_l01[0], Cellids1, Energies1)

    emax_l02[0] = cal2Emax
    e2max_l02[0] = Find2ndMax(Energies2,Cellids2,2)
