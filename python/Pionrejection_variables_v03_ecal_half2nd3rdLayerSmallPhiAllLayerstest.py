...
def Find2ndMax(Energies,Cells,Distance):
    ...
    try:
        Extrema = n.sort(Energies[argrelextrema(Filtered_Energies,n.greater, order = 3)])
...
def Shower_width(Energies, Cells, j):
    ...
    try:
        ...
        for cell in Cells:
            ...
            try:
                if (dp <= 2 or dp >= (largestPhiValue-2)) and de <= limeta:
...
for event in intree:
    ...
    eocore_l00[0] = eocorey(cal0Emax, Cellids0, Energies0, 5)
    ...
    eocore_l01[0] = eocorey(cal1Emax, Cellids1, Energies1, 8)
    ...
    eocore_l02[0] = eocorey(cal2Emax, Cellids2, Energies2, 5)
    ...
    eocore_l03[0] = eocorey(cal3Emax, Cellids3, Energies3, 8)
    ...
    eocore_l04[0] = eocorey(cal4Emax, Cellids4, Energies4, 8)
