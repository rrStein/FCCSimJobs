...
eospath = '/afs/cern.ch/user/r/rastein/public/pionrejection/v03_ecal_fineEta2ndLayer/'
...
bkgTree = eospath + 'pi0/10GeV/pi0_fineEta2ndLayer_10GeV.root'
sigTree = eospath + 'photon/10GeV/photon_fineEta2ndLayer_10GeV.root'
...
#nTrain = 50000
nTrain = 0
label = 'pi0_vs_photon_fineEta2ndLayer_10GeV'
