...
eospath = '/afs/cern.ch/user/r/rastein/public/pionrejection'
...
bkgTree = eospath + '/pi0/10GeV/pi0_basic_10GeV.root'
sigTree = eospath + '/photon/10GeV/photon_basic_10GeV.root'
...
#nTrain = 50000
nTrain = 0
label = 'pi0_vs_photon_basic_10GeV'
