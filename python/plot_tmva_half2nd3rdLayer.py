...
TrainType = "pi0_vs_photon_half2nd3rdLayer_"
TrainMethod = "BDT_"
unit = "GeV"
...
canvas2 = r.TCanvas( 'canvas', '#scale[1.1]{#pi_{0}} rejection at different energies', 200, 10, 700, 500 )
...
#axis.Draw()
leg = r.TLegend(0.50,0.62,0.76,0.86)
leg.SetFillColor(0)
