...
gr1 = r.TGraphAsymmErrors(1,array('d',x),array('d',y2),array('d',ex1),array('d',ex1),array('d',ey2l),array('d',ey2h))
gr1.SetLineWidth(2)
...
gr1.SetTitle("Half2nd3rdLayerSmallPhiAllLayers")
...
leg.SetFillColorAlpha(r.kYellow-10,0.5)
...
leg.AddEntry(line,"Pion rejection threshold = 3","l")
leg.Draw("same")
