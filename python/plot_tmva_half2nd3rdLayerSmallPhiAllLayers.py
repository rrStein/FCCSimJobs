...
Training_Energies = n.array([10,15,20,25,30,35,40,45,50,55,60,65,70,75,80])
...
#axis.Draw()
leg = r.TLegend(0.48,0.64,0.90,0.84)
leg.SetFillColor(0)
...
leg.SetTextFont(42)
leg.AddEntry(gr1,"90% #pm "+str(sigerr2)+"% Signal Efficiency","lp")
leg.AddEntry(gr2,"80% #pm "+str(sigerr1)+"% Signal Efficiency","lp")
leg.AddEntry(line,"#scale[1.1]{#pi_{0}} rejection threshold = 3","l")
leg.Draw("same")
...
canvas2.Modified()
canvas2.Update()
canvas2.Print("pi0Rej_H23LSPALAllvar.pdf")
