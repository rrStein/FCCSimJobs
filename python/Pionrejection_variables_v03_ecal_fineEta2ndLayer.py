...
w9st_l00 = n.zeros(1, dtype=float)
w41st_l00 = n.zeros(1, dtype=float)
...
w9st_l02 = n.zeros(1, dtype=float)
w41st_l02 = n.zeros(1, dtype=float)
...
w9st_l03 = n.zeros(1, dtype=float)
w41st_l03 = n.zeros(1, dtype=float)
...
w9st_l04 = n.zeros(1, dtype=float)
w41st_l04 = n.zeros(1, dtype=float)'''
...
outtree.Branch("w9st_l00", w9st_l00, "w9st_l00/D")
outtree.Branch("w41st_l00", w41st_l00, "w41st_l00/D")
...
outtree.Branch("w9st_l02", w9st_l02, "w9st_l02/D")
outtree.Branch("w41st_l02", w41st_l02, "w41st_l02/D")
...
outtree.Branch("w9st_l03", w9st_l03, "w9st_l03/D")
outtree.Branch("w41st_l03", w41st_l03, "w41st_l03/D")
...
outtree.Branch("w9st_l04", w9st_l04, "w9st_l04/D")
outtree.Branch("w41st_l04", w41st_l04, "w41st_l04/D")'''
...
for event in intree:
    ...
    for e in Energies0:
        ...
        if e > cal0E2max and e > cal0Emax*0.66 and dist > 2:
            cal0E2max = e
            cal0Phi2max = newEta0
            cal0Eta2max = newPhi0
    ...
    for e in Energies1:
        ...
        if e > cal1E2max and e > cal1Emax*0.66 and dist > 2:
            cal1E2max = e
            cal1Phi2max = newEta1
            cal1Eta2max = newPhi1
    ...
    for e in Energies2:
        ...
        if e > cal2E2max and e > cal2Emax*0.66 and dist > 2:
            cal2E2max = e
            cal2Phi2max = newEta2
            cal2Eta2max = newPhi2
    ...
    '''for e in Energies3:
        ...
        if e > cal3E2max and e > cal3Emax*0.66 and dist > 2:
            cal3E2max = e
            cal3Phi2max = newEta3
            cal3Eta2max = newPhi3
    ...
    for e in Energies4:
        ...
        if e > cal4E2max and e > cal4Emax*0.66 and dist > 2:
            cal4E2max = e
            cal4Phi2max = newEta4
            cal4Eta2max = newPhi4'''
    ...
    if cal0E2max > 0:
        w9st_l00[0] = Shower_width(Energies0, Cellids0, 9)
        w41st_l00[0] = Shower_width(Energies0, Cellids0, 41)
    ...
    if cal2E2max > 0:
        w9st_l02[0] = Shower_width(Energies2, Cellids2, 9)
        w41st_l02[0] = Shower_width(Energies2, Cellids2, 41)
    ...
    '''if cal3E2max > 0:
        w9st_l03[0] = Shower_width(Energies3, Cellids3, 9)
        w41st_l03[0] = Shower_width(Energies3, Cellids3, 41)
    ...
    if cal4E2max > 0:
        w9st_l04[0] = Shower_width(Energies4, Cellids4, 9)
        w41st_l04[0] = Shower_width(Energies4, Cellids4, 41)
